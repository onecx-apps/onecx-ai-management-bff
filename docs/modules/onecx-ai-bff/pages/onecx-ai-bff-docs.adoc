...
quarkus.openapi-generator.codegen.spec.ai_management_internal_openapi_yaml.base-package=gen.org.tkit.onecx.ai.mgmt.client
...
include::onecx-ai-bff-extensions.adoc[opts=optional]
